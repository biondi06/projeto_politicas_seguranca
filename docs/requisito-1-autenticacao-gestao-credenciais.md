...
![Evidência da segurança das credenciais](evidencias/seguranca_credenciais_argon2id_2fa.png)
...
![Evidência da ativação do 2FA](evidencias/ativar_verificacao.png)
...
![Evidência da confirmação do 2FA](evidencias/fa_confirmado.png)
...
![Evidência da autenticação](evidencias/autenticacao.png)
...
![Evidência do Rate Limit](evidencias/rate_limit.png)

### Tela de bloqueio

![Evidência da tela de limite](evidencias/tela_limit.png)
...
![Evidência da sessão validada](evidencias/sessao_validada.png)

### Sessão invalidada

![Evidência da sessão invalidada](evidencias/sessao_invalidada.png)
