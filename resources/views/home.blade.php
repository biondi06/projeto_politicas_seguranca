    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            background:
                radial-gradient(
                    720px 420px at 84% -12%,
                    rgba(198, 135, 58, 0.17),
                    transparent 61%
                ),
                radial-gradient(
                    500px 300px at 15% 100%,
        ...
        .privacy-button.secondary {
            background: transparent;
            color: var(--teal-700);
            border: 1px solid rgba(27, 94, 90, .28);
        }
        ...
        <div class="container">
            <div class="nav">
                ...
                <a
                    href="{{ route('landing') }}"
                    class="wordmark"
                    aria-label="Ecoa — Página inicial"
                >
                    <img
                        src="{{ asset('img/ecoa-icone.png') }}"
                        alt="Ecoa"
                    >
                </a>
                        ...
                        <div class="account-dropdown" role="menu">
                            ...
                            >
                                <svg
                                    ...
                                    stroke-linejoin="round"
                                >
                                    <path d="M12 3 5 6v5c0 4.5 7.5 10 7 10 4-2.5 7-5.5 7-10V6l-7-3Z"></path>
                    ...
                    <div class="banner">
                        ...
                        <div class="banner-icon">
                            ...
                            <svg
                                ...
                                stroke-linejoin="round"
                            >
                                <path d="M12 3 5 6v5c0 4.5 7 7.5 7 10 4-2.5 7-5.5 7-10V6l-7-3Z"></path>
                                <path d="M12 8v4"></path>
            ...
            <section class="privacy-panel">
                ...
                <div class="privacy-header">
                    ...
                    <div class="privacy-title">
                        ...
                        <p>
                            Consulte e gerencie os dados pessoais associados à sua conta.
                        </p>
                ...
                <div class="privacy-content">
                    ...
                    <div class="privacy-status">
                        ...
                        <div class="privacy-status-top">
                            ...
                            <strong>
                                Seus dados estão disponíveis para consulta
                            </strong>

                        </div>

                        <p>
                            O Ecoa permite consultar os dados cadastrais,
                            verificar o histórico de consentimentos,
                            exportar suas informações, revogar consentimentos
                            e solicitar a exclusão dos dados pessoais.
                        </p>
                    ...
                    <div class="privacy-meta">
                        ...
                        <div class="privacy-meta-item">
                            ...
                            <strong>
                                {{ $ultimoConsentimento?->versao_termo ?? 'Não informado' }}
                            </strong>
                        ...
                        <div class="privacy-meta-item">
                            ...
                            <strong>
                                {{ $ultimoConsentimento?->finalidade ?? 'Não informado' }}
                            </strong>
                        ...
                        <div class="privacy-meta-item">
                            ...
                            <strong>
                                {{ $ultimoConsentimento?->aceito_em?->format('d/m/Y H:i') ?? 'Não informado' }}
                            </strong>
                ...
                <div class="privacy-actions">
                    ...
                    <a
                        href="{{ route('lgpd.exportar') }}"
                        class="privacy-button secondary"
                    >
