...
<head>
    ...
    * {
    ...
    .nav-cta:hover {
        ...
        background: rgba(198, 135, 58, 0.12);
    }
    ...
    .btn-primary:hover {
        ...
        box-shadow: 0 16px 34px rgba(198, 135, 58, 0.36);
    }
    ...
    .ring-a {
        stroke: rgba(185, 207, 192, 0.55);
    }

    .ring-b {
        stroke: rgba(198, 135, 58, 0.55);
    }

    .ring-c {
        stroke: rgba(244, 246, 242, 0.35);
    }
    ...
    @media (prefers-reduced-motion: no-preference) {
        ...
        .pulse-2 {
            animation: pulse 4.5s ease-out 1.5s infinite;
        }

        .pulse-3 {
            animation: pulse 4.5s ease-out 3s infinite;
        }
    }
...
<body>
    ...
    <main>
        ...
        <section class="block" id="ciclo">
            <div class="container loop-wrap">
                <div>
                    ...
                    <ul class="loop-list">
                        ...
                        <li>
                            ...
                            <div>
                                <h4>Ajustar</h4>
                                <p>Fonoaudiólogo, pediatra e terapeuta ocupacional revisam o plano juntos — e o ciclo
                                    recomeça.</p>
                            </div>
                        </li>
                    </ul>
                ...
                <svg class="loop-diagram" viewBox="-45 -15 510 450" aria-hidden="true">
                    ...
                    <text x="210" y="205" text-anchor="middle" font-family="Newsreader, serif" font-size="16"
                        fill="#16231f">Plano</text>
                    <text x="210" y="226" text-anchor="middle" font-family="Newsreader, serif" font-size="16"
                        fill="#16231f">terapêutico</text>
                </svg>
            </div>
        </section>
        ...
        <section class="block" id="recursos"
            style="background:var(--paper-dim); border-top:1px solid var(--line); border-bottom:1px solid var(--line);">
            <div class="container">
                ...
                <div class="features-grid">
                    <div class="feature-card">
                        ...
                        <p>Fonoaudiólogo, pediatra e terapeuta ocupacional comentam e ajustam o mesmo plano — sem
                            decisão isolada de um só profissional.</p>
                    </div>
                    <div class="feature-card">
                        <span class="feature-tag">Biblioteca</span>
                        <h3>Exercícios de estimulação</h3>
                        <p>Catalogados por fonema e dificuldade, com instruções claras para os pais reproduzirem em casa
                            corretamente.</p>
                    </div>
                    <div class="feature-card">
                        <span class="feature-tag">Acompanhamento</span>
                        <h3>Diário de evolução</h3>
                        <p>Progresso das sessões e dos exercícios em casa, relatado pelo profissional ou pela família,
                            sempre com data e origem.</p>
                    </div>
                    <div class="feature-card">
                        <span class="feature-tag">Gestão</span>
                        <h3>Painel do coordenador</h3>
                        <p>Visão consolidada de quantas crianças estão em acompanhamento e quais planos aguardam
                            revisão.</p>
                    </div>
                </div>
            </div>
        ...
        <section class="closing">
            <div class="container">
                ...
                <p>Sem substituir o trabalho clínico — só organizando o que já acontece entre profissionais, todos os
                    dias.</p>
                <div class="cta-row">
                    ...
                    <a href="mailto:contato@ecoa.app" class="btn btn-ghost">
                        Falar com a equipe
                    </a>
